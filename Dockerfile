...
# add current porject
ADD . /go/src/github.com/zainul/arkana-kit

# set working dir
WORKDIR /go/src/github.com/zainul/arkana-kit
...
# build the binary
RUN go build /go/src/github.com/zainul/arkana-kit/cmd/main.go

CMD ["/go/src/github.com/zainul/arkana-kit/cmd/main"]
